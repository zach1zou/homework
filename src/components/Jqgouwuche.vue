            ...
            <div class="w">
                ...
                <div class="cart-warp">
                    ...
                    <div class="cart-item-list">
                        <div class="cart-item check-cart-item" v-for="(item,index) in goods" :key="item.id">
                            <div class="p-checkbox">
                                <input type="checkbox" name="" id="" class="j-checkbox" v-model="item.flag">
                            </div>
                            <div class="p-goods">
                                <div class="p-img">
                                </div>
                            ...
                            <div class="p-num">
                                <div class="quantity-form">
                                    <a href="javascript:;" class="decrement" @click="numDel(index)">-</a>
                                    <input type="text" class="itxt" v-model="item.num">
                                    <a href="javascript:;" class="increment" @click="numAdd(index)">+</a>
                                </div>
                            </div>
                            <div class="p-sum">￥{{(item.price*item.num).toFixed(2)}}</div>
                            <div class="p-action"><a href="javascript:;" @click="delFn(item.id)">删除</a></div>
                        </div>
                    ...
                    <div class="cart-floatbar">
                        ...
                        <div class="toolbar-right">
                            ...
                            <div class="price-sum">总价： <em>{{ getTotalPrice.toFixed(2) }}</em></div>
...
export default {
  ...
  data () {
    ...
    methods: {
        ...
        numDel(ind) { 
            this.goods[ind].num > 0 ? this.goods[ind].num--:0
